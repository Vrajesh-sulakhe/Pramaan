...
import { RunResponse, AuditEvent } from '@pramaan/contracts'; // Import shared types
import { mockRunResponse, mockConsentResponse } from './mockRun'; // Your fake data
...
export async function fetchRun(input: {
  ...
  if (MODE === 'mock') {
    console.log('[DataSource] MOCK MODE: Returning hand-built JSON');
    // Simulate network delay so it feels real
    await new Promise((r) => setTimeout(r, 800));
    return mockRunResponse; // Returns your hardcoded ProofCards + HoldChip data
  }
