...
export const BILL_RULEBOOK_STUB = [
    {
        rule_id: "BR-001",
        domain: "bill",
        ...
        rule_says_plain: "Paracetamol 500mg tablet is price-capped at ₹2 per tablet under DPCO 2013.",
        severity: "high",
        status: "VERIFIED",
    ...
    },
    {
        ...
        official_source_url: "https://cghs.gov.in/ShowWriteup.aspx?id=rate-list-radiology",
        rule_says_plain: "MRI scan rate under CGHS 2023 is ₹6,400 per scan at empanelled hospitals.",
        severity: "high",
        status: "VERIFIED",
    ...
    },
    {
        ...
        official_source_url: "https://cghs.gov.in/ShowWriteup.aspx?id=rate-list-pathology",
        rule_says_plain: "Complete Blood Count (CBC) / Haemogram rate under CGHS 2023 is ₹150.",
        severity: "medium",
        status: "VERIFIED",
