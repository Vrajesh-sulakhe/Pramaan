...
// ── Tool 1: lookup_rule ──────────────────────────────────────────────────────
server.tool("lookup_rule", "Search the rulebook for rows matching the given text. Returns [] on no match — not an error.", {
...
// ── Tool 2: place_hold ───────────────────────────────────────────────────────
server.tool("place_hold", "Place a provisional hold on an invoice. Idempotent — same (invoice_id, evidence_pack_id) always returns the same hold.", {
...
server.tool("get_hold_status", "Get the current status of a hold by its hold_id.", {
...
// ── Tool 4: release_hold ─────────────────────────────────────────────────────
server.tool("release_hold", "Release a hold. Returns the updated HoldEvent with status 'released'.", {
