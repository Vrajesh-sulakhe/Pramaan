...
var h = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-DWkAgceV-HDUEVYG5.js")).iosTransitionAnimation : (await import("./p-BsBCoGa--RK2W7HLS.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-A3O24YmY.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-DUUM44RD.js.map
