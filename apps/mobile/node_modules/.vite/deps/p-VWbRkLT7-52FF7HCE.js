import {
  i as i2,
  t
} from "./chunk-3HQE2MWA.js";
import {
  f,
  i,
  m
} from "./chunk-S4YIIMAU.js";
import {
  d,
  o
} from "./chunk-XEUXXMKQ.js";
import {
  e,
  l,
  u
} from "./chunk-Y6ID374G.js";
import "./chunk-3ED65HUI.js";
...
var v = async (o2, n, r, a, e2, s, d2 = false, c = 0, l3 = true) => {
  if (!r && !a) return;
  ...
  if (u2(o2, n, true, f3.inputSafeY, d2), D(n), s && r && (y = f3.scrollPadding, h(r, y)), "undefined" != typeof window) {
    let a2;
    const e3 = async () => {
      void 0 !== a2 && clearTimeout(a2), window.removeEventListener("ionKeyboardDidShow", d3), window.removeEventListener("ionKeyboardDidShow", e3), r && await f(r, 0, f3.scrollAmount, f3.scrollDuration), u2(o2, n, false, f3.inputSafeY), document.activeElement === n && D(n), s && b(n, r, () => y = 0);
    }, d3 = () => {
...
var x = async (t2, i3) => {
  if (void 0 === o) return;
  const l3 = "ios" === i3, f3 = "android" === i3, w2 = t2.getNumber("keyboardHeight", 290), m3 = t2.getBoolean("scrollAssist", true), h2 = t2.getBoolean("hideCaretOnScroll", l3), b2 = t2.getBoolean("inputBlurring", false), y2 = t2.getBoolean("scrollPadding", true), D2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = await t.getResizeMode(), g = async (n) => {
...
@ionic/core/components/p-VWbRkLT7.js:
   ...
   *)
*/
//# sourceMappingURL=p-VWbRkLT7-52FF7HCE.js.map
